...
<template>
  <div 
    :class="[
      'rounded-lg border p-4 mb-4 transition-all duration-300',
  ...
  >
    <div class="flex items-start">
      ...
      <div class="flex-shrink-0 mr-3">
        ...
        <svg 
          v-if="type === 'error'"
          :class="['w-5 h-5', currentClasses.icon]"
          fill="currentColor" 
          viewBox="0 0 20 20"
        >
          <path 
      ...
      <!-- Action Button -->
      <div v-if="action" class="ml-4 flex-shrink-0">
        <button
          @click="handleAction"
          :class="[
            'inline-flex text-sm font-medium transition-colors duration-200',
